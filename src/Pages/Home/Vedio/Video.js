...
const Video = () => {
    return (
        <div className='flex mx-10 justify-center items-center my-32'>
            ...
            <p className='text-xl pt-4 text-center font-normal'  style={{ fontFamily:  'Playfair Display'  }}>Our Biryani and other delicious food have earned a name through <br/> our loyal patrons over the years. Now we are happy  to bring our new official <br/> ‘Foodka’  Application to enjoy  the same delicacies on the go.  Forget  <br/> the blues amidst  our authentic  flavors at a click.</p>
        </div>

        <div id="aboutvideo" className='flex w-1/2 '>
