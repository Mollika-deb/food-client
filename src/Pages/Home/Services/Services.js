...
const Services = () => {
    ...
    return (
        <div className=''>
            <div className='mt-32'>
            <h1 className='text-6xl text-center text-orange-700' style={{ fontFamily: 'Playfair Display',   }}>Recommendations</h1>
                <h2 className='text-4xl text-center font-semibold pt-3' style={{ fontFamily: 'Playfair Display', color: '#7A942E' }}>Our Featured Meals
                </h2>
