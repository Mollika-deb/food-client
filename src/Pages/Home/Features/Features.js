...
const Features = () => {
    return (
       ...
       <div className='  mx-auto pb-20'>
        <div>
            <h2 className='text-3xl lg:text-4xl text-center text-orange-700' style={{ fontFamily: 'Playfair Display ',   }}>Plan Your Event With</h2>
            ...
            <p className='text-base pb-7 text-center font-normal hidden lg:block'  >Our Biryani and other delicious food have earned a name through our loyal patrons over the years. <br/> Now we are happy  to bring our new official  ‘Foodka’  Application to enjoy  the same delicacies on the go.  </p>
        </div >
