...
const Footer = () => {
    return (
        <footer className="footer footer-center mt-52 p-24 bg-base-200 text-base-content rounded mt-16">
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by mollika1551@gmail.com</p>
  </div>
</footer>
    );
};
